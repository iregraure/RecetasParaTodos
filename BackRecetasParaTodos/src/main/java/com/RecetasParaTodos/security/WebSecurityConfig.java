...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter
{
	...
	protected void configure(HttpSecurity http) throws Exception
	{
		http.cors().and().csrf().disable().authorizeRequests()
				...
				.antMatchers(HttpMethod.POST, "/nacionalidad").permitAll().antMatchers(HttpMethod.GET, "/receta/*")
				.permitAll().antMatchers(HttpMethod.POST, "/receta/*").permitAll()
				.antMatchers(HttpMethod.PUT, "/receta/*").permitAll().antMatchers(HttpMethod.DELETE, "/receta/*")
